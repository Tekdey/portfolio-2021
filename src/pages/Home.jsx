  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="h-screen w-screen absolute flex">
        <motion.div variants={vHome.navTop} initial="initial" animate="animate" exit="exit" transition={vHome.navTransition} className="w-screen text-black text-2xl justify-center items-center flex py-5 absolute top-0 p-10">
        ...
        <motion.div variants={vHome.navLeft} initial="initial" animate="animate" exit="exit" transition={vHome.navTransition} className="h-screen text-orange-500 text-2xl justify-center items-center flex py-5 absolute left-0" >
          <LinkButton href="/about" className="-rotate-90 mix-blend-difference" draggable="false" externalLink={false}>About</LinkButton>
        </motion.div>

        <motion.div variants={vHome.navRight} initial="initial" animate="animate" exit="exit" transition={vHome.navTransition} className="h-screen text-orange-500 text-2xl justify-center items-center flex py-5 absolute right-0">
          <LinkButton href="/tutorial" className=" rotate-90 mix-blend-difference" draggable="false" externalLink={false}>Tutorial</LinkButton>
        </motion.div>

        <motion.div variants={vHome.navBottom} initial="initial" animate="animate" exit="exit" transition={vHome.navTransition} className="w-screen text-orange-500 text-2xl justify-around items-center flex py-5 absolute bottom-0">
